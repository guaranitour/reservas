...
function renderConfirmedPage(pairs) {
  ...
  wrap.innerHTML = `
    ...
    <p class="confirmed-sub">${tripName
      ? 'Tu lugar en <strong>' + tripName + '</strong> está asegurado.'
      : 'Tu lugar está asegurado. ¡Gracias por reservar!'
    }</p>`;
  ...
  // Hint captura
  wrap.innerHTML += `
    <div class="confirmed-hint">
      📸 Guardá una captura como comprobante
    </div>`;
